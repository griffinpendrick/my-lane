...
if not exist C:\my-lane\bin mkdir C:\my-lane\bin 
pushd C:\my-lane\bin 
...
cl %CompilerFlags% C:\my-lane\src\main.cpp /I %IncludePath% /link /LIBPATH:C:\opencv\build\x64\vc16\lib opencv_world4120.lib %LinkerFlags% /OUT:mylane.exe 
